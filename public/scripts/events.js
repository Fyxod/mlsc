...
function swapFirst() {
    if (!(i.style.backgroundImage.includes("../assets/images/delta.webp"))) {
        p.textContent = "Delta, a three-day flagship event, featured a Cryptic Hunt on day 1, a Treasure Hunt on day 2, and a Gaming Night on day 3, offering participants a blend of challenging puzzles, adventurous quests, and competitive gaming.";
        i.style.opacity = 0;
        p.style.opacity = 0;
...
function swapSecond() {
    if (!(i.style.backgroundImage.includes("../assets/images/astellar.webp"))) {
        p.textContent = "Astellar featured a 24-hour Cryptic Hunt followed by a Gaming Night, offering participants the chance to win prizes worth ₹12,000. It combined intellectual challenge with competitive gaming for an engaging and rewarding experience.";
        i.style.opacity = 0;
        p.style.opacity = 0;
...
function swapThird() {
    if (!(i.style.backgroundImage.includes("../assets/images/thirdimage.jpg"))) {
        p.textContent = "Hallo, es ist sehr schwierig, das Fett loszuwerden. Macht es große Freude daran? Zu diesem Zeitpunkt wird jemand darunter leiden oder ihn sogar hassen, denn wenn wir dazu geboren werden, zu wählen, werden wir Probleme haben!";
        i.style.opacity = 0;
        p.style.opacity = 0;
        btn1.style.color = "rgba(92, 92, 92, 0.736)";
        btn1.style.borderLeftColor = "rgba(92, 92, 92, 0.736)";
